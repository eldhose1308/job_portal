	...
	class Template {
		...
		function home_views($template = NULL, $data = NULL) {
			if ($template != NULL) {
				...
				// Header
				$data['_navbar'] 				= $this->_ci->load->view('home/_layouts/_navbar', $data, TRUE);
				$data['_sidebar'] 				= $this->_ci->load->view('home/_layouts/_sidebar', $data, TRUE);
				$data['_preloader'] 				= $this->_ci->load->view('home/_layouts/_preloader', $data, TRUE);
				

				//Content
				$data['_message'] 		= $this->_ci->load->view('home/_layouts/_message', $data, TRUE);
				$data['_mainContent'] 		= $this->_ci->load->view($template, $data, TRUE);
