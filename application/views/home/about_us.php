          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-6">
                ...
                <p class="font-lg color-text-paragraph-2">What we are & What we do</p>
              </div>
          ...
          <div class="container">
            ...
            <div class="row mt-70">
              <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-md-30">
                <div class="card-grid-4 text-center hover-up">
                  <div class="image-top-feature">
                    <figure><img alt="jobBox" src="<?= base_url() ?>assets/users/imgs/page/about/team1.png"></figure>
                  </div>
                  <div class="card-grid-4-info">
                    ...
                    <div class="rate-reviews-small pt-5"><span><img src="<?= base_url() ?>assets/users/imgs/template/icons/star.svg" alt="jobBox"></span><span><img src="<?= base_url() ?>assets/users/imgs/template/icons/star.svg" alt="jobBox"></span><span><img src="<?= base_url() ?>assets/users/imgs/template/icons/star.svg" alt="jobBox"></span><span><img src="<?= base_url() ?>assets/users/imgs/template/icons/star.svg" alt="jobBox"></span><span><img src="<?= base_url() ?>assets/users/imgs/template/icons/star.svg" alt="jobBox"></span><span class="ml-10 color-text-mutted font-xs"><span>(</span><span>65</span><span>)</span></span></div><span class="card-location">New York, US</span>
              ...
              <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-md-30">
                <div class="card-grid-4 text-center hover-up">
                  <div class="image-top-feature">
                    <figure><img alt="jobBox" src="<?= base_url() ?>assets/users/imgs/page/about/team2.png"></figure>
                  </div>
                  <div class="card-grid-4-info">
                    <h5 class="mt-10">Floyd Miles</h5>
                    <p class="font-xs color-text-paragraph-2 mt-5 mb-5">UI/UX Designer</p>
                    <div class="rate-reviews-small pt-5"><span><img src="<?= base_url() ?>assets/users/imgs/template/icons/star.svg" alt="jobBox"></span><span><img src="<?= base_url() ?>assets/users/imgs/template/icons/star.svg" alt="jobBox"></span><span><img src="<?= base_url() ?>assets/users/imgs/template/icons/star.svg" alt="jobBox"></span><span><img src="<?= base_url() ?>assets/users/imgs/template/icons/star.svg" alt="jobBox"></span><span><img src="<?= base_url() ?>assets/users/imgs/template/icons/star.svg" alt="jobBox"></span><span class="ml-10 color-text-mutted font-xs"><span>(</span><span>28</span><span>)</span></span></div><span class="card-location">Chicago, US</span>
                    <div class="text-center mt-30"><a class="share-facebook social-share-link" href="#"></a><a class="share-twitter social-share-link" href="#"></a><a class="share-instagram social-share-link" href="#"></a><a class="share-linkedin social-share-link" href="#"></a></div>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-md-30">
                <div class="card-grid-4 text-center hover-up">
                  <div class="image-top-feature">
                    <figure><img alt="jobBox" src="<?= base_url() ?>assets/users/imgs/page/about/team3.png"></figure>
                  </div>
                  <div class="card-grid-4-info">
              ...
              <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-md-30">
                <div class="card-grid-4 text-center hover-up">
                  <div class="image-top-feature">
                    <figure><img alt="jobBox" src="<?= base_url() ?>assets/users/imgs/page/about/team4.png"></figure>
                  </div>
                  <div class="card-grid-4-info">
              ...
              <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-md-30">
                <div class="card-grid-4 text-center hover-up">
                  <div class="image-top-feature">
                    <figure><img alt="jobBox" src="<?= base_url() ?>assets/users/imgs/page/about/team5.png"></figure>
                  </div>
                  <div class="card-grid-4-info">
              ...
              <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-md-30">
                <div class="card-grid-4 text-center hover-up">
                  <div class="image-top-feature">
                    <figure><img alt="jobBox" src="<?= base_url() ?>assets/users/imgs/page/about/team6.png"></figure>
                  </div>
                  <div class="card-grid-4-info">
              ...
              <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-md-30">
                <div class="card-grid-4 text-center hover-up">
                  <div class="image-top-feature">
                    <figure><img alt="jobBox" src="<?= base_url() ?>assets/users/imgs/page/about/team7.png"></figure>
                  </div>
                  <div class="card-grid-4-info">
              ...
              <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-md-30">
                <div class="card-grid-4 text-center hover-up">
                  <div class="image-top-feature">
                    <figure><img alt="jobBox" src="<?= base_url() ?>assets/users/imgs/page/about/team8.png"></figure>
                  </div>
                  <div class="card-grid-4-info">
