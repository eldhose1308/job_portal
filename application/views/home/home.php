                    ...
                    <div class="col-xl-7 col-lg-12">
                        <div class="block-banner">
                            ...
                            <div class="mt-30">
                                ...
                                <a href="<?= base_url() ?>about_us" class="btn btn-border-brand-2">Learn more</a>
                            </div>
                    ...
                    <div class="swiper-container swiper-group-6 mh-none swiper">
                        <div class="swiper-wrapper pb-70 pt-5">
                            <div class="swiper-slide hover-up">
                                <div class="card-grid-5 card-category hover-up" style="background-image: url('<?= base_url() ?>assets/users/imgs/page/homepage4/img-big1.png')"><a href="jobs-grid.html">
                            ...
                            <div class="swiper-slide hover-up">
                                <div class="card-grid-5 card-category hover-up" style="background-image: url('<?= base_url() ?>assets/users/imgs/page/homepage4/img-big2.png')"><a href="jobs-grid.html">
                                        <div class="box-cover-img">
                                            <div class="content-bottom">
                            ...
                            <div class="swiper-slide hover-up">
                                <div class="card-grid-5 card-category hover-up" style="background-image: url('<?= base_url() ?>assets/users/imgs/page/homepage4/img-big3.png')"><a href="jobs-grid.html">
                                        <div class="box-cover-img">
                                            <div class="content-bottom">
                            ...
                            <div class="swiper-slide hover-up">
                                <div class="card-grid-5 card-category hover-up" style="background-image: url('<?= base_url() ?>assets/users/imgs/page/homepage4/img-big4.png')"><a href="jobs-grid.html">
                                        <div class="box-cover-img">
                                            <div class="content-bottom">
                            ...
                            <div class="swiper-slide hover-up">
                                <div class="card-grid-5 card-category hover-up" style="background-image: url('<?= base_url() ?>assets/users/imgs/page/homepage4/img-big5.png')"><a href="jobs-grid.html">
                                        <div class="box-cover-img">
                                            <div class="content-bottom">
                            ...
                            <div class="swiper-slide hover-up">
                                <div class="card-grid-5 card-category hover-up" style="background-image: url('<?= base_url() ?>assets/users/imgs/page/homepage4/img-big6.png')"><a href="jobs-grid.html">
                                        <div class="box-cover-img">
                                            <div class="content-bottom">
