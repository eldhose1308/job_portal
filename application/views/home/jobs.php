                            ...
                            <div class="col-xl-12 col-12">
                                <div class="card-grid-2 hover-up"><span class="flash"></span>
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="card-grid-2-image-left">
                                                <div class="image-box"><img src="<?= base_url() ?>assets/users/imgs/brands/brand-1.png" alt="jobBox"></div>
                                    ...
                                    <div class="card-block-info">
                                        <h4><a href="#">UI / UX Designer fulltime</a></h4>
                            ...
                            <div class="col-xl-12 col-12">
                                <div class="card-grid-2 hover-up"><span class="flash"></span>
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="card-grid-2-image-left">
                                                <div class="image-box"><img src="<?= base_url() ?>assets/users/imgs/brands/brand-2.png" alt="jobBox"></div>
                                    ...
                                    <div class="card-block-info">
                                        <h4><a href="#">Full Stack Engineer</a></h4>
                            ...
                            <div class="col-xl-12 col-12">
                                <div class="card-grid-2 hover-up"><span class="flash"></span>
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="card-grid-2-image-left">
                                                <div class="image-box"><img src="<?= base_url() ?>assets/users/imgs/brands/brand-3.png" alt="jobBox"></div>
                                    ...
                                    <div class="card-block-info">
                                        <h4><a href="#">Java Software Engineer</a></h4>
                            ...
                            <div class="col-xl-12 col-12">
                                <div class="card-grid-2 hover-up"><span class="flash"></span>
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="card-grid-2-image-left">
                                                <div class="image-box"><img src="<?= base_url() ?>assets/users/imgs/brands/brand-4.png" alt="jobBox"></div>
                            ...
                            <div class="col-xl-12 col-12">
                                <div class="card-grid-2 hover-up"><span class="flash"></span>
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="card-grid-2-image-left">
                                                <div class="image-box"><img src="<?= base_url() ?>assets/users/imgs/brands/brand-5.png" alt="jobBox"></div>
                                                <div class="right-info"><a class="name-job" href="#">Linkedin</a><span class="location-small">New York, US</span></div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 text-start text-md-end pr-60 col-md-6 col-sm-12">
                            ...
                            <div class="col-xl-12 col-12">
                                <div class="card-grid-2 hover-up"><span class="flash"></span>
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="card-grid-2-image-left">
                                                <div class="image-box"><img src="<?= base_url() ?>assets/users/imgs/brands/brand-6.png" alt="jobBox"></div>
                            ...
                            <div class="col-xl-12 col-12">
                                <div class="card-grid-2 hover-up"><span class="flash"></span>
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="card-grid-2-image-left">
                                                <div class="image-box"><img src="<?= base_url() ?>assets/users/imgs/brands/brand-7.png" alt="jobBox"></div>
                            ...
                            <div class="col-xl-12 col-12">
                                <div class="card-grid-2 hover-up"><span class="flash"></span>
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="card-grid-2-image-left">
                                                <div class="image-box"><img src="<?= base_url() ?>assets/users/imgs/brands/brand-8.png" alt="jobBox"></div>
