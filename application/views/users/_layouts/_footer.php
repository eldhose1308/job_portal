    ...
    <div class="row mt-5">
      <div class="col-lg-3 col-md-6">
        <div class="footer-link">
          ...
          <ul class="list-unstyled">
            <li><a href="<?= base_url() ?>assets/users/#">Browse Jobs</a></li>
            <li><a href="<?= base_url() ?>assets/users/#">Browse Categories</a></li>
            <li><a href="<?= base_url() ?>assets/users/#">Submit Resume</a></li>
            <li><a href="<?= base_url() ?>assets/users/#">Candidate Dashboard</a></li>
            <li><a href="<?= base_url() ?>assets/users/#">Job Alerts</a></li>
            <li><a href="<?= base_url() ?>assets/users/#">My Bookmarks</a></li>
          </ul>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 mt-4 mt-md-0">
        <div class="footer-link">
          ...
          <ul class="list-unstyled">
            <li><a href="<?= base_url() ?>assets/users/#">Shortcodes</a></li>
            <li><a href="<?= base_url() ?>assets/users/#">Job Page</a></li>
            <li><a href="<?= base_url() ?>assets/users/#">Job Page Alternative</a></li>
            <li><a href="<?= base_url() ?>assets/users/#">Resume Page</a></li>
            <li><a href="<?= base_url() ?>assets/users/#">Blog</a></li>
            <li><a href="<?= base_url() ?>assets/users/#">Contact</a></li>
          </ul>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-6 mt-4 mt-lg-0">
        ...
        <div class="footer-subscribe">
          ...
          <div class="d-inline-block">
            <a class="btn btn-white btn-sm btn-app " href="<?= base_url() ?>assets/users/#">
            ...
            <a class="btn btn-white btn-sm btn-app mt-3" href="<?= base_url() ?>assets/users/#">
      ...
      <div class="row">
        ...
        <div class="col-md-6 text-center text-md-end mt-4 mt-md-0">
          <p class="mb-0"> &copy;Copyright <span id="copyright">
            ...
            </span> <a href="<?= base_url() ?>assets/users/#"> Jobber </a> All Rights Reserved </p>
        </div>
      </div>
    </div>
  </div>
