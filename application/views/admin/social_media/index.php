  ...
  <section class="content-main">
      <div class="content-header">
          <div>
              <h2 class="content-title card-title">Social media links List</h2>
              <p>List of social media links in this portal.</p>
          </div>



          <div class="col-6 col-md-3">
              <a href="<?= base_url() ?>admin/social_media/add_social_media" class="btn btn-primary float-end">Add social media link</a>
          </div>
      ...
      <div class="card mb-4">
          ...
          <header class="card-header">
              <div class="row gx-3">
                  ...
                  <form action="<?= base_url() ?>admin/social_media/social_media_json" class="datatable-list row">
