                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input data-validation="" <?= ($operation == 'view') ? 'disabled' : '' ?> value="<?= (!empty($candidatesDetails)) ? $candidatesDetails->user_name : ''; ?>" type="text" class="form-control" name="user_name" id="user_name" placeholder="User name">
                                </div>
