        ...
        <?php if ($operation != 'view') :  ?>
            ...
            <div class="col-12 mb-10">
                <div class="content-header">
                    <div>
                        <button type="submit" id="submit-form" class="btn btn-custom font-sm hover-up submit-form float-right"><?= ($operation == 'add') ? 'Add' : 'Update'; ?> Country &nbsp; <i class="fas fa-sign-in-alt"></i></button>
                    </div>
                </div>
            </div>
