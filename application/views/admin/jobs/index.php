                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 text-lg-end mt-sm-15">
                        <div class="display-flex2">
                            ...
                            <form action="<?= base_url() ?>admin/jobs/jobs_json" class="datacard-list">
                    ...
                    <div class="col-xl-3 col-lg-3 text-end">
                        <button class="btn btn-sm btn-custom open-offcanvas" data-url="<?= base_url() ?>admin/jobs/add_jobs">Add</button>
                    </div>
