...
<section class="content-main">
    <?php if ($operation == 'add') : ?>
        <?php echo form_open(base_url('admin/about_us/save_fourth_image'), 'class="form-horizontal" id="add-form-with-imagecrop" enctype="multipart/form-data"') ?>
    <?php endif;
    if ($operation == 'edit') :  ?>
        <?php echo form_open(base_url('admin/about_us/update_fourth_image'), 'class="form-horizontal" id="add-form-with-imagecrop" enctype="multipart/form-data"') ?>
            ...
            <div class="card card-primary">
                ...
                <div class="card-body" style="overflow-y:scroll;">
                    ...
                    <?php if ($operation != 'add') : ?>
                        ...
                        <img src="<?= base_url() ?>uploads/about_us/<?= $about_usDetails->about_image_4 ?>" class="previous_image" alt="about_us Image">
                    <?php endif; ?>
