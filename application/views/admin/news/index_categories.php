  ...
  <section class="content-main">
      <div class="content-header">
          <div>
              <h2 class="content-title card-title">News categories List</h2>
              <p>List of news categories in this portal.</p>
          </div>



          <div class="col-6 col-md-3">
              <a href="<?= base_url() ?>admin/news/add_categories" class="btn btn-primary float-end">Add category</a>
          </div>
      ...
      <div class="card mb-4">
          <header class="card-header">
              <div class="row gx-3">
                  ...
                  <form action="<?= base_url() ?>admin/news/categories_json" class="datatable-list row">
