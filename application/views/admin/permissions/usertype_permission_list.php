  ...
  <section class="content-main">
    <div class="col-12">
      <div class="content-header">
        <h2 class="content-title">Change permissions for user types</h2>
        <div>
    ...
    <div class="card">
      <div class="result card-body table-responsive">
          ...
          <tbody>
            ...
            <?php foreach ($menusList as $menuLists) :  ?>
              <tr>
                ...
                $menusAccess = $this->M_permissions->list_modules_access_usertype($module_id, $ut_id);
        ...
        <input type="hidden" value="<?= $ut_id ?>" id="ut_id">
      </div>
    </div>
  </section>
  ...
  <script>
    $('.form-check-input').on('change', function() {
      ...
      var access_xhr = $.post('<?= base_url('change_module_permission_usertype'); ?>', {
