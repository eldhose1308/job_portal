  ...
  <section class="content-main">
      <div class="content-header">
          <div>
              ...
              <p>List of video galleries in this portal.</p>
          </div>


          <div class="col-6 col-md-3">
              <a href="<?= base_url() ?>admin/video_gallery/add_video_gallery" class="btn btn-primary float-end">Add video link</a>
          </div>
      ...
      <div class="card mb-4">
          <header class="card-header">
              <div class="row gx-3">
                  ...
                  <form action="<?= base_url() ?>admin/video_gallery/video_gallery_json" class="datatable-list row">
