  ...
  <section class="content-main">
      <div class="content-header">
          <div>
              <h2 class="content-title card-title">Donations Maintypes List</h2>
              <p>List of donations maintypes in this portal.</p>
          </div>



          <div class="col-6 col-md-3">
              <a href="<?= base_url() ?>admin/donations/add_main_types" class="btn btn-primary float-end">Add maintypes</a>
          </div>
      ...
      <div class="card mb-4">
          <header class="card-header">
              <div class="row gx-3">
                  ...
                  <form action="<?= base_url() ?>admin/donations/main_types_json" class="datatable-list row">
