  ...
  <section class="content-main">
      <div class="content-header">
          <div>
              <h2 class="content-title card-title">Donations Subtypes List</h2>
              <p>List of donations subtypes in this portal.</p>
          </div>



          <div class="col-6 col-md-3">
              <a href="<?= base_url() ?>admin/donations/add_sub_types" class="btn btn-primary float-end">Add subtypes</a>
          </div>
      ...
      <div class="card mb-4">
          <header class="card-header">
              <div class="row gx-3">
                  ...
                  <form action="<?= base_url() ?>admin/donations/sub_types_json" class="datatable-list row">
                      ...
                      <div class="col-6 col-md-3 filter">
                          <select class="form-control float-end" name="type_id" id="type_id">
                              <option value="-1">Show all types</option>
                              <?php foreach ($mainTypes as $main_types) : 
                                   $status_badge = ($main_types->visible == 1) ? 'Visible' : 'Hidden';
                                ?>
                                  <option value="<?= en_func($main_types->type_id, 'e') ?>"><?= $main_types->type_name . ' - ' . $status_badge ?></option>
                              <?php endforeach; ?>
                          </select>
                      </div>
