...
<link rel="stylesheet" href="<?= base_url() ?>assets/admin/css/datacards.css">
  ...
  <section class="content-main">
      <div class="content-header">
          <div>
              <h2 class="content-title card-title">Events List</h2>
              <p>List of events in this portal.</p>
          </div>


          <div class="col-6 col-md-3">
              <a href="<?= base_url() ?>admin/events/add_events" class="btn btn-primary float-end">Add events</a>
          </div>
      ...
      <div class="card mb-4">
          <header class="card-header">
              <div class="row gx-3">
                  ...
                  <form action="<?= base_url() ?>admin/events/events_json" class="datacard-list row">
