  ...
  <section class="content-main">
      <div class="content-header">
          <div>
              <h2 class="content-title card-title">Administration year List</h2>
              <p>List of administration years in this portal.</p>
          </div>


          <div class="col-6 col-md-3">
              <a href="<?= base_url() ?>admin/administration/add_years" class="btn btn-primary float-end">Add years</a>
          </div>
      </div>
      ...
      <div class="card mb-4">
          <header class="card-header">
              <div class="row gx-3">
                  ...
                  <form action="<?= base_url() ?>admin/administration/years_json" class="datatable-list row">
