  ...
  <section class="content-main">
    <div class="content-header">
      ...
      <div class="col-6 col-md-5">
        <a href="<?= base_url() ?>admin/users/add_users" class="btn btn-primary load-btn btn-sm float-end">Create new <i class="m-1 fa fa-plus-circle"></i></a>
      </div>
    ...
    <div class="card mb-4">
      <header class="card-header">
        <div class="row gx-3">
          ...
          <form action="<?= base_url() ?>admin/users/users_json" class="datatable-list row">

            <div class="col-md-3 me-auto"></div>

            <div class="col-4 col-md-3 filter">
