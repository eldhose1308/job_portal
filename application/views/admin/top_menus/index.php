  ...
  <section class="content-main">
      <div class="content-header">
          <div>
              <h2 class="content-title card-title">TopMenus List</h2>
              <p>List of top menus in this portal.</p>
          </div>



          <div class="col-6 col-md-3">
              <a href="<?= base_url() ?>admin/menus/add_topmenus" class="btn btn-primary float-end">Add top menu</a>
          </div>
      ...
      <div class="card mb-4">
          <header class="card-header">
              <div class="row gx-3">
                  ...
                  <form action="<?= base_url() ?>admin/menus/topmenus_json" class="datatable-list row">
                      ...
                      <div class="col-12 col-md-3 mb-15">
                          <a href="<?= base_url() ?>admin/menus/sub_menus" class="load-btn btn btn-light rounded font-sm mr-5 text-body hover-up">Add sub menu</a>
                      </div>
