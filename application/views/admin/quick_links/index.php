  ...
  <section class="content-main">
      <div class="content-header">
          <div>
              <h2 class="content-title card-title">Quick links List</h2>
              <p>List of quick links in this portal.</p>
          </div>



          <div class="col-6 col-md-3">
              <a href="<?= base_url() ?>admin/quick_links/add_quick_links" class="btn btn-primary float-end">Add quick link</a>
          </div>
      ...
      <div class="card mb-4">
          ...
          <header class="card-header">
              <div class="row gx-3">
                  ...
                  <form action="<?= base_url() ?>admin/quick_links/quick_links_json" class="datatable-list row">
