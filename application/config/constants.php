...
define('EVENTS_IMAGES', $base_url. 'uploads/events/');
define('BANNER_IMAGES', $base_url. 'uploads/banner/');
define('ADMINISTRATION_IMAGES', $base_url. 'uploads/administration/');

define('ABOUT_US_IMAGES', $base_url. 'uploads/about_us/');
